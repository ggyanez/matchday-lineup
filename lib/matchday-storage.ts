...
/**
 * Keeps the in-progress Match Day selection (who's confirmed, the last
 * generated lineup, etc.) in the browser's localStorage, so navigating
 * away to Players and back doesn't lose it. This is purely a per-device
 * convenience — nothing here is shared or synced, and it's fine for it
 * to come back empty (private browsing, cleared site data, ...).
 */
...
const STORAGE_KEY = "matchday-lineup:draft:v1";
